...
class Auth {
  constructor() {
    ...
    this.auth = axios.create({
      ...
      baseURL: 'https://avance-app.herokuapp.com'
  ...
  addActivity(activityName, positiveGoal, negativeGoal, data) {

    return this.auth
      .post('/user/addActivity', { activityName, positiveGoal, negativeGoal, userId: this.userId, data })
      .then((response) => {
        return response.data;
      });
  }
  ...
  getUserFeed() {
    console.log(`Getting user feed for ${this.userId} from ${BACKEND_URL}`);
